...
const rootDir = 'C:\\\\Medikiosk\\\\backend';
...
writeFile('src/config/database.ts', `
...
writeFile('src/models/Patient.ts', `
...
writeFile('src/models/Session.ts', `
import mongoose, { Schema, Document } from 'mongoose';
...
writeFile('src/models/Conversation.ts', `
import mongoose, { Schema, Document } from 'mongoose';
...
writeFile('src/models/Document.ts', `
import mongoose, { Schema, Document } from 'mongoose';
...
writeFile('src/models/ClinicalHistory.ts', `
import mongoose, { Schema, Document } from 'mongoose';
...
writeFile('src/models/AyushRecord.ts', `
import mongoose, { Schema, Document } from 'mongoose';
...
writeFile('src/repositories/InMemoryStore.ts', `
...
repos.forEach(repo => {
    writeFile(\`src/repositories/\${repo.name}Repository.ts\`, \`
import { \${repo.iface}, \${repo.model} } from '../models/\${repo.name}';
...
writeFile('src/services/ai/LLMProvider.ts', \`
import { IClinicalDraft } from '../../models/ClinicalHistory';
...
writeFile('src/services/ai/SummaryService.ts', \`
import { ILLMProvider, ClinicalDraft } from './LLMProvider';
...
writeFile('src/services/asr/ASRProvider.ts', \`
...
writeFile('src/services/asr/DemoASR.ts', \`
...
writeFile('src/services/asr/PrimaryASR.ts', \`
import { IASRProvider } from './ASRProvider';
...
writeFile('src/services/asr/BhashiniASR.ts', \`
import { IASRProvider } from './ASRProvider';
...
writeFile('src/services/ocr/OCRProvider.ts', \`
...
writeFile('src/services/ocr/MockOCR.ts', \`
...
writeFile('src/services/fhir/FHIRService.ts', \`
...
writeFile('src/services/ayush/AyushService.ts', \`
...
writeFile('src/services/cache/CacheService.ts', \`
...
writeFile('src/controllers/sessionController.ts', \`
...
writeFile('src/controllers/conversationController.ts', \`
import { Request, Response } from 'express';
...
writeFile('src/controllers/asrController.ts', \`
import { Request, Response } from 'express';
...
writeFile('src/controllers/ocrController.ts', \`
import { Request, Response } from 'express';
...
writeFile('src/controllers/summaryController.ts', \`
import { Request, Response } from 'express';
import { ConversationRepository } from '../repositories/ConversationRepository';
...
writeFile('src/controllers/physicianController.ts', \`
import { Request, Response } from 'express';
import { ClinicalHistoryRepository } from '../repositories/ClinicalHistoryRepository';
import { SessionRepository } from '../repositories/SessionRepository';
import { PatientRepository } from '../repositories/PatientRepository';
...
writeFile('src/controllers/fhirController.ts', \`
import { Request, Response } from 'express';
...
writeFile('src/controllers/ayushController.ts', \`
import { Request, Response } from 'express';
...
writeFile('src/routes/sessionRoutes.ts', \`
...
writeFile('src/routes/conversationRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/asrRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/ocrRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/summaryRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/physicianRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/fhirRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/routes/ayushRoutes.ts', \`
import { Router } from 'express';
...
writeFile('src/seed/demoData.ts', \`
import { PatientRepository } from '../repositories/PatientRepository';
import { SessionRepository } from '../repositories/SessionRepository';
import { ConversationRepository } from '../repositories/ConversationRepository';
import { ClinicalHistoryRepository } from '../repositories/ClinicalHistoryRepository';
